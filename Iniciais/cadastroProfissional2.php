    ...
    <div class="login-container">
      ...
      <form id="form-cadastro" method="POST" action="cadastroProfissionalFinal.php" class="login-form">
        ...
        <div class="login-input-group" id="group-tel">
          <input id="telefone" name="telefone" class="login-input" type="tel" placeholder="27 988123456" pattern="(?:\d{2}|\(\d{2}\))\s?9\d{4}[-\s]?\d{4}" autocomplete="off" required/>
        ...
        <div class="checkbox">
          ...
          <label for="termos">
            Li e concordo com os <a href="termos_condicoes.pdf" target="_blank">Termos & Condições</a> 
e com a <a href="politicas_privacidade.pdf" target="_blank">Política de Privacidade</a>
          </label>
        </div> <br>
